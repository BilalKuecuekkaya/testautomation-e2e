...
*** Test Cases ***
Open_Application    
    Open Application    http://10.1.0.44:4724/wd/hub     platformName=Android	    deviceName=RF8T90V5A7H    appPackage=com.purplepro.app   appActivity=com.purplepro.app.MainActivity     automationName=Uiautomator2   
