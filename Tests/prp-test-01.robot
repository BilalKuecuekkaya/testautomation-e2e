...
*** Test Cases ***
Open_Application    
    Open Application    http://127.0.0.1:4724    platformName=Android	    deviceName=RF8T90V5A7H    appPackage=com.purplepro.app   appActivity=com.purplepro.app.MainActivity     automationName=Uiautomator2   
