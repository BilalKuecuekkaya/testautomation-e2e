...
*** Test Cases ***
Open_Application    
    Open Application    URL == ${HTTP_DEVICE}     platformName=Android	    deviceName=RF8T90V5A7H    appPackage=com.purplepro.app   appActivity=com.purplepro.app.MainActivity     automationName=Uiautomator2   
